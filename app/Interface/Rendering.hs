...
drawBaseAreas = pictures
    ...
    , translate (158) (158) $ color blue (rectangleSolid squareSize squareSize)       -- Área azul
    , translate (-158) (-158) $ color green (rectangleSolid squareSize squareSize)    -- Área verde
    , translate (158) (-158) $ color yellow (rectangleSolid squareSize squareSize)    -- Área amarela
    ]
...
drawPaths = pictures
    ...
    , translate (2 * cellSize) 0 $ color yellow (rectangleSolid cellSize cellSize)  
    , translate 0 (-2 * cellSize) $ color green (rectangleSolid cellSize cellSize)  
    , translate 0 (2 * cellSize) $ color blue (rectangleSolid cellSize cellSize)  
    ...
    , pictures [translate (5 * cellSize - (i * cellSize)) 0 $ color yellow (rectangleSolid cellSize cellSize) | i <- [0..4]]
    , pictures [translate 0 (-5 * cellSize + (i * cellSize)) $ color green (rectangleSolid cellSize cellSize) | i <- [0..4]]
    , pictures [translate 0 (5 * cellSize - (i * cellSize)) $ color blue (rectangleSolid cellSize cellSize) | i <- [0..4]]
    ...
    , translate (5 * cellSize) (-1 * cellSize) $ color yellow (rectangleSolid cellSize cellSize)
    , translate (1 * cellSize) (5 * cellSize) $ color blue (rectangleSolid cellSize cellSize)
